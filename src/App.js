        ...
        <>
            ...
            <main>
                ...
                <div className="mostPopularContainer">
                    <div  className="MostPopularHome">
                        <a href="http://https://cocktailicious.nl/pina-colada/">
                            <img alt="mostPopularCocktail1" src="/Images/Pina Colada.jpeg"/>
                        </a>
                        <p>
                    ...
                    <div className="MostPopularHome">
                        <a>
                            <img alt="mostPopularCocktail2" src="/Images/Tequila Sunrise.jpeg"/>
                        </a>
                        <p>
                    ...
                    <div className="MostPopularHome">
                        <a>
                            <img alt="mostPopularCocktail3" src="/Images/Sex%20on%20the%20beach.jpg"/>
                        </a>
                        <p>
                ...
                <div className="bannerInbetween">
                    <img alt="banner inbetween" src="/Images/Banner.jpg"/>
                </div>
